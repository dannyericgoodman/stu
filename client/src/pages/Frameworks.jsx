...
// ════════════════════════════════════════════════════════
// Frameworks — the Assessment Architect.
//
// Investors define what THEY assess instead of inheriting a rubric. Three
// ways in: describe it in plain words (the architect drafts the questions),
// start from a preset, or start blank. The draft is always editable before
// saving — the investor owns the yardstick, not the model.
// ════════════════════════════════════════════════════════
